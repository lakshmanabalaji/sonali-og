  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Ensure renderer clear color matches preset background so colors appear as intended
        if (options && options.colors && options.colors.background != null) {
          try {
            this.renderer.setClearColor(new THREE.Color(options.colors.background), 1);
          } catch (e) {
            // fallback: set numeric color
